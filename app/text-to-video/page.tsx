    ...
    <div className="min-h-screen bg-[#f5f1e8]">
        ...
        <div className="bg-white rounded-2xl shadow-2xl border-4 border-[#2d3e2d] overflow-hidden max-w-4xl mx-auto">
          ...
          <div className="p-8 text-center">
            ...
            <div className="bg-[#f5f1e8] rounded-xl p-6 mb-6">
              <h4 className="font-black text-[#2d3e2d] mb-3" style={{ fontFamily: "Comic Sans MS, cursive" }}>
                What to expect:
              </h4>
      ...
      <section className="container mx-auto px-4 py-8">
        <div className="text-center mb-6">
          <h2 className="text-2xl font-black text-[#2d3e2d] mb-2" style={{ fontFamily: "Comic Sans MS, cursive" }}>
        ...
        <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
          <Link href="/" className="block">
            <div className="bg-gradient-to-br from-[#d4a574] to-[#c19660] border-2 border-[#2d3e2d] rounded-xl p-4 transform hover:scale-105 transition-all text-center">
              ...
              <h3 className="font-black text-[#2d3e2d] text-sm" style={{ fontFamily: "Comic Sans MS, cursive" }}>
                Image to Image
              </h3>
          ...
          <Link href="/text-to-image" className="block">
            <div className="bg-gradient-to-br from-[#8b7355] to-[#6d5a42] border-2 border-[#2d3e2d] rounded-xl p-4 transform hover:scale-105 transition-all text-center">
              ...
              <h3 className="font-black text-[#f5f1e8] text-sm" style={{ fontFamily: "Comic Sans MS, cursive" }}>
                Text to Image
              </h3>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-black text-[#2d3e2d] mb-6 text-center" style={{ fontFamily: "Comic Sans MS, cursive" }}>
          ...
          <div className="prose prose-lg mx-auto">
            ...
            <h3 className="text-2xl font-black text-[#2d3e2d]" style={{ fontFamily: "Comic Sans MS, cursive" }}>
