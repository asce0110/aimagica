                ...
                <div className="relative aspect-video">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                    <div className="p-3 text-white">
                      <h3 className="font-black text-lg" style={{ fontFamily: "Comic Sans MS, cursive" }}>
                        {example.title}
                      </h3>
                    </div>
                  </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              ...
              >
                ...
                <p className="text-[#8b7355] font-bold mb-4" style={{ fontFamily: "Comic Sans MS, cursive" }}>
                  "作为一名内容创作者，AIMAGICA Video
                  Studio彻底改变了我的工作方式！我可以快速将创意转变为精美视频，为我的社交媒体带来了更多互动和关注。"
                </p>
                <div className="flex justify-end">
                  <span className="text-[#d4a574] font-bold text-sm" style={{ fontFamily: "Comic Sans MS, cursive" }}>
                    内容创作者
                  </span>
                </div>
              </div>
            ...
            <div className="text-center mt-10">
              <div className="inline-flex items-center bg-[#2d3e2d] rounded-full px-6 py-3 shadow-lg">
                ...
                <span className="text-[#f5f1e8] font-black" style={{ fontFamily: "Comic Sans MS, cursive" }}>
