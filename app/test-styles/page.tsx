        ...
        <Card className="bg-white border-4 border-[#8b7355] rounded-2xl shadow-xl">
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="p-4 bg-[#f5f1e8] rounded-xl border-2 border-[#8b7355]/30">
              ...
              <ul className="space-y-1 text-sm text-[#8b7355] font-bold" style={{ fontFamily: "Comic Sans MS, cursive" }}>
                <li>📸 必须上传参考图片</li>
                <li>✍️ 必须输入描述</li>
                <li>📝 描述至少 10 个字符</li>
                <li>🖼️ 支持格式：jpg, jpeg, png, webp</li>
              </ul>
              <p className="text-xs text-[#8b7355] mt-2" style={{ fontFamily: "Comic Sans MS, cursive" }}>
