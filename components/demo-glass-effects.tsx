        ...
        <TabsContent value="cards" className="mt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <MobileOptimizedCard title="主色调玻璃卡片" icon={<Sparkles className="w-5 h-5" />} color="primary">
              <p className="text-[#f5f1e8] font-bold" style={{ fontFamily: "Comic Sans MS, cursive" }}>
            ...
            <MobileOptimizedCard title="强调色玻璃卡片" icon={<Wand2 className="w-5 h-5" />} color="accent">
              <p className="text-[#2d3e2d] font-bold" style={{ fontFamily: "Comic Sans MS, cursive" }}>
          ...
          <GlassMorphism intensity="light" color="neutral">
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[#2d3e2d] font-bold mt-4" style={{ fontFamily: "Comic Sans MS, cursive" }}>
                  🧙‍♂️ 如何使用：
                </p>
