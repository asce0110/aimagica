            ...
            <div className="space-y-4">
              <div className="bg-[#f5f1e8] rounded-xl p-4 border-2 border-[#8b7355]">
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="font-black text-[#2d3e2d]" style={{ fontFamily: "Comic Sans MS, cursive" }}>
                    Text to Video Magic! 📝✨
                  </h3>
                </div>
                <p className="text-[#8b7355] font-bold text-sm mb-4" style={{ fontFamily: "Comic Sans MS, cursive" }}>
              ...
              <div className="bg-[#f5f1e8] rounded-xl p-4 border-2 border-[#8b7355]">
                ...
                <div className="border-2 border-dashed border-[#8b7355] rounded-xl p-4 text-center mb-4 bg-white min-h-[200px] flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-[#8b7355] text-xs mt-2" style={{ fontFamily: "Comic Sans MS, cursive" }}>
