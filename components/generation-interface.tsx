                ...
                {uploadedImage && !showDrawing ? (
                  ...
                  <div className="border-2 border-dashed border-[#8b7355] rounded-xl p-6 bg-[#f5f1e8]">
                    <div className="text-center mb-4">
                      <h4 className="text-[#2d3e2d] font-bold text-lg mb-2" style={{ fontFamily: "Comic Sans MS, cursive" }}>
                        🖼️ Edit Your Image!
                      </h4>
                    ...
                    <div className="mt-4 text-center">
                      ...
                      <p className="text-[#8b7355] text-sm mt-2 font-bold" style={{ fontFamily: "Comic Sans MS, cursive" }}>
